...
SAVE_DIR = r'C:\Users\User\Desktop\Sitting_posture_research\data\custom'
VIDEO_PATH = os.path.join(r'C:\Users\User\Desktop\Sitting_posture_research\videos', VIDEO_NAME)

if not os.path.exists(SAVE_DIR): os.makedirs(SAVE_DIR)

# Use direct package attribute access to bypass Windows namespace issues
